...
*/
	...
	return array(
		...
		'options' => 'options',
		'options_reset' => '설정 초기화 성공',
		'options_saved' => '설정 저장 성공',
		...
		'reset_options_button' => '초기값 복원',
		'reset_options_confirm' => '이 페이지의 모든 설정값을 초기화하시겠습니까?',
		'resume_mailing_button' => 'Resume Mailing',
		'save_options_button' => '설정 저장',
		...
		'url_format_note' => '^ 표시가 있는 옵션만 정상적으로 동작합니다. 검색엔진 최적화(SEO)를 위해서는 ^ 표시가 된 옵션 중 최상단에 있는 옵션을 선택하시는 것이 유리합니다. ',
